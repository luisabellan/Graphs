...
(100 * 10) / 2 = 1000 / 2 = 500 times
Because if we have two friends, Alex and Mike, for example. If Alex is friends with Mike then Mike is already friends with Alex. Thus we don't want to have to call add_friendship() twice hence we divide by two
